...
export default function LoginScreen() {
  ...
  const { signIn, signInWithGoogle, signInWithGitHub, signInWithPhone, verifyOTP, sendPasswordResetEmail } = useAuth();
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error.message || 'Failed to login with GitHub');
    } finally {
      setLoading(false);
    }
  };
